...
imageDir = "F:/pixiv_images/train_v2_flip"  #要改变的图片的路径文件夹
saveDir = "F:/pixiv_images/train_v2"   #要保存的图片的路径文件夹
i = 1
for name in os.listdir(imageDir):

    saveName = "fog1_"+str(i)+".jpg" #保存的文件名
    saveImage = flip(imageDir,name)    #()前函数改成功能对应的函数名，即可使用
