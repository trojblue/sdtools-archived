...
def get_parser():
  parser = argparse.ArgumentParser(description='Resize images in mecha_tags folder')
  ...
  parser.add_argument('-suffix', '--size', type=int,
...
def check_is_need_modify(img:Image, expected_l:int):
  ...
  # modify image if it'suffix not jpeg or it'suffix size is larger than expected_l
