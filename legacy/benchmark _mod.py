...
def do_benchmark(model_name:str="NONAME"):
    ...
    preset_FIXED_PROMPT = {
        ...
        "sampler_list": ["DDIM", "DPM++ 2M Karras", "DPM++ 2S mecha_tags Karras"],
    ...
    preset_FIXED_PROMPT_LESS = {
        ...
        "sampler_list": ["Euler mecha_tags", "Euler", "Heun", "DPM++ SDE Karras"],
        "step_list": [31, 39, 52],
        "cfg_list": [6.5],
        "resolution": resolution_random,
        "prompt_list": [p_cake]
    ...
    preset_VERY_FAST_PROMPT = {
        ...
        "sampler_list": ["DDIM", "DPM++ 2M Karras", "Euler mecha_tags", "Heun"],
        "step_list": [25, 29],
        "cfg_list": [6.5],
        "resolution": resolution_illust,
        "prompt_list": random_prompt_list
