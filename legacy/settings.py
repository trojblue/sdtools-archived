...
anime_sfw_settings = GenSettings(
    vital_tags="mecha_tags clean painting of (best quality:1.5),finely detailed, illustration, ultra-detailed, amazing fine details and brush strokes, 1girl",
    taboo_tags="yoneyama mai, maimuro, blush, antlers, umbrella, white umbrella, bruise,horns, jack-o'-lantern, heterochromia, ball gag, gag, tape gag, wings, angel wings, deveil wings",
...
p_purple_jirai = "mecha_tags clean illustration of (best_quality:1.3), masterpiece, by sks, 1girl, eye-focus, hyperkawaii, foreshortening, purple pink hair,  :0, (((low_twintails))), long_hair, bangs, (demon_wings), (grey eyes), nails, long puffy sleeves, ((pointy ears)), (short ears), (((((black jacket))))), ribbons, low twintails, [[[sailor collar]]], ahoge, hyper-kawaii, yuzuki_yukari, realistic_lighting, looking_up, (yuzuki_yukari:1) , (bare legs), black boots, ribbons on sleeves, jirai-kei, harajuku-kei, ribbon on sleeves, [[[[art by wild_card]]]], ultra-detailed, amazing fine details and brush strokes"
...
preset_EVAL_MODEL_RANDOM_longer = {
    ...
    "sampler_list": "Euler, Euler mecha_tags, DDIM, DPM++ 2M Karras, DPM++ 2S mecha_tags Karras, Heun".split(", "),
    "step_list": [15, 25, 39, 52],
    "cfg_list": [6.5],
    "resolution": resolution_random,
    "prompt_list": []
